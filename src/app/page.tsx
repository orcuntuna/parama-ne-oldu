        ...
        <div className="mt-10 flex lg:space-x-8 flex-col lg:flex-row">
          ...
          <div className="lg:flex-1 mt-4 lg:mt-0">
            ...
            <div className="mt-2">
              <input
                required={true}
                value={String(oldMoney) || ""}
                onChange={(e) => setOldMoney(Number(e.target.value))}
                type="number"
                id="start-money"
                    ...
                    <table className="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody className="divide-y divide-gray-200 bg-white">
                        <tr>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.oldUsd
                            )}{" "}
                            $
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.newUsd
                            )}{" "}
                            $
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.expectedUsdToTry
                            )}{" "}
                            TL
                          </td>
                          <td
                          ...
                          >
                            {new Intl.NumberFormat().format(
                              convertedResult.differenceUsdToTry
                            )}{" "}
                            TL
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.oldEur
                            )}{" "}
                            €
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.newEur
                            )}{" "}
                            €
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.expectedEurToTry
                            )}{" "}
                            TL
                          </td>
                          <td
                          ...
                          >
                            {new Intl.NumberFormat().format(
                              convertedResult.differenceEurToTry
                            )}{" "}
                            TL
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.oldGold
                            )}{" "}
                            gram
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.newGold
                            )}{" "}
                            gram
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            {new Intl.NumberFormat().format(
                              convertedResult.expectedGoldToTry
                            )}{" "}
                            TL
                          </td>
                          <td
                          ...
                          >
                            {new Intl.NumberFormat().format(
                              convertedResult.differenceGold
                            )}{" "}
                            gram
                          </td>
                          <td
                          ...
                          >
                            {new Intl.NumberFormat().format(
                              convertedResult.differenceGoldToTry
                            )}{" "}
                            TL
                          </td>
                        </tr>

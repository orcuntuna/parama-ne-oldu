        ...
        <li className="col-span-1 flex rounded-md shadow-sm">
          ...
          <div
            ...
            <div className="flex-1 truncate px-4 py-2 text-sm">
              ...
              <p className="text-gray-500">{selectedDate.text}: <span
                className="font-medium text-black">{selectedDate.currency.usd}</span></p>
        ...
        <li className="col-span-1 flex rounded-md shadow-sm">
          ...
          <div
            ...
            <div className="flex-1 truncate px-4 py-2 text-sm">
              ...
              <p className="text-gray-500">{selectedDate.text}: <span
                className="font-medium text-black">{selectedDate.currency.eur}</span></p>
        ...
        <li className="col-span-1 flex rounded-md shadow-sm">
          ...
          <div
            ...
            <div className="flex-1 truncate px-4 py-2 text-sm">
              ...
              <p className="text-gray-500">{selectedDate.text}: <span
                className="font-medium text-black">{selectedDate.currency.gold}</span></p>
